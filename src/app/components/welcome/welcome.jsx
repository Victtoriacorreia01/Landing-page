...
const Welcome = () => {
    return (
        <div className="firstdiv bg-gradient-animation w-screen h-screen flex items-center">
            <div className="secdiv lg:ml-20 sm:mx-0 sm:w-1/2">
            ...
            Infraestrutura de pagamentos <br /> para a internet
                ...
                <p className='p lg:mt-10 lg:ml-16 text-sm sm:ml-0 sm:mt-4' data-aos="fade-left">Milhões de empresas de todos os tamanhos usam a Milk <br />e presencialmente para receber pagamentos, enviar repasses,<br /> automatizar processos financeiros e ampliar suas receitas.</p>
            ...
            <div className='img hidden sm:block'>
                <div className="image-container">
                    < Image src={fotoprincipal} className="w-2/3 ml-40" alt="Foto principal" data-aos="fade-right" quality={true} />
                </div>
            </div>
        </div>
    );
